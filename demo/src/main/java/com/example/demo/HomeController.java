...
public class HomeController {
    ...
    public String multiFieldSearch(
            @ModelAttribute VideoSearch search, Model model, Authentication authentication) {
    ...
    public String universalSearch(
            @ModelAttribute UniversalSearch search, Model model, Authentication authentication) {
        List<VideoEntity> searchResults = videoService.search(search);
        model.addAttribute("videos", searchResults);
        model.addAttribute("search", search);
        model.addAttribute("authentication", authentication);
